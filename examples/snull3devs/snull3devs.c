...
int snull_open(struct net_device *dev)
{
	...
	/*For Debug: Copy the adress and convert it for print out*/
...
struct net_device *snull_devs[3];
...
int snull_init_module(void)
{
	...
	snull_devs[0] = alloc_netdev(sizeof(struct snull_priv), "plc1", NET_NAME_UNKNOWN,
			snull_init);
	snull_devs[1] = alloc_netdev(sizeof(struct snull_priv), "plc2", NET_NAME_UNKNOWN,
			snull_init);
	snull_devs[2] = alloc_netdev(sizeof(struct snull_priv), "plc3", NET_NAME_UNKNOWN,
			snull_init);
	if (snull_devs[0] == NULL || snull_devs[1] == NULL || snull_devs[2] == NULL)
		goto out;
